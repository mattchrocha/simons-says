    ...
    return (
      <div style={{width: "100vw", display: "flex", position:"relative", zIndex: "1"}}>
        <main className="tap-main-container">
          ...
          <figure>
              <img src={setButtons} alt="Set Buttons Step" className="tap-homelogo one"/>
          </figure>

          <div className="tap-hometext">
          Add buttons to the game by accessing the following address in any smartphone
          </div>

          <div className="tap-input roomname">tapcode.it/<br />{this.state.roomName}</div>

          <div className="tap-hometext" style={{marginTop: "16px"}}>
          Add as many as you want!
          </div>
          
          <div className="bottom-message" style={{marginTop: "0"}}>{buttonsNumber}</div>

          <OutlineButton text="Next >" isDisabled={isDisabled} onClick={e => this.handleSubmit()} message={message}/>
